export class FileSaver {
    ...
    private self: any;
    private currentFileName = 'download';
    private currentMimeType = 'application/octet-stream';
    private anchor: any;
    private blob: any;
    ...
    private dataUrlToBlob( strUrl: string ): any
    {
        ...
        return new this.currentBlob([uiArr], {type});
    }
    ...
    {
        const version: Array<any> = navigator.userAgent.match(/version\/(\d+).(\d+)/i);
